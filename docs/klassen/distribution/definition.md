...
De `spdx:Checksum` klasse bevat naast de berekende checksum-waarde ook een eigenschap die het gebruikte algoritme
aangeeft. Hiervoor is een [waardelijst](#waardelijst-spdx-ChecksumAlgorithm) opgezet.
...
|----------------------|---------------------------------------------------------------------------|---------------|
| `spdx:algorithm`     | [waardelijst spdx:ChecksumAlgorithm](#waardelijst-spdx-ChecksumAlgorithm) | `1..1`        |
